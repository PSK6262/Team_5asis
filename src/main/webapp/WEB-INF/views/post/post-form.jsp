...
<body>
					...
					<form id="postForm"
						...
						<div class="form-group">
							<label class="form-label">카테고리</label> <select name="category"
								class="category-select" required>
								<option value=""disabled ${emptypost.category ? 'selected' : ''}>카테고리
									선택</option>
								<option value="파티모집"
									${post.category == '파티모집' ? 'selected' : ''}>파티모집</option>
						...
						<div class="form-group">
							<label class="form-label">제목</label> <input type="text"
								name="title" class="title-input" value="${post.title}"
	...
	<!-- 외부 JS 파일 로드 -->
	<script
		src="${pageContext.request.contextPath}/resources/js/postForm.js"></script>
</body>
</html>