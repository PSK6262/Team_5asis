		...
		<div class="pagebody-rightside flex-grow-1">
			<div class="content-header-nav mb-3">
			    <nav aria-label="breadcrumb">
			        <ol class="breadcrumb mb-0">
			            <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/5asis">홈</a></li>
				    ...
				    <div class="trend-post-list">
				        <c:forEach var="post" items="${selectedTrendPost}">
				            <c:if test="${not empty post.rownum}">
				                <div class="trend-post-item gameboard-post-view d-flex align-items-center justify-content-between" onclick="gameBoardPostClickEvent(${post.pid})">
				                    ...
				                    <!-- 작성자 및 메타 정보 (조회수, 좋아요) -->
				                    <div class="trend-meta-info d-flex align-items-center flex-shrink-0 ms-3">
				                        <span class="trend-nickname text-muted small me-3 d-none d-md-inline">${post.nickname}</span>
				                        <span class="trend-stat me-2 small text-secondary">
				                            조회수 ${post.viewCount}
				                        </span>
				                        <span class="trend-stat small text-danger fw-semibold">
				                            좋아요 ${post.likeCount}
				                        </span>
				                    </div>
				                </div>
			...
			<div class="d-flex justify-content-between align-items-center mb-3 mt-4">
			    ...
			    <div class="write-btn-wrapper">
			        <button type="button" class="btn-board-write" onclick="location.href='${pageContext.request.contextPath}/post/post-form?gameAlias=${gameAlias}' ">
			            글쓰기
			        </button>
			    </div>
			</div>	
